    ...
    return (
        <div className='userAll'>
            <div className='userHeader'>
                ...
                <img src={Edit} alt="Subir imagen" className='uploadImage' onClick={handleImageClick} />
                ...
                <div className='userMiddle_Container'>
                    ...
                    <div className='userMiddle_Input4'>
                        ...
                        <select id='sexOptions' name='sexo'>
                            <option value="opcion1"> F</option>
                            <option value="opcion1"> M</option>
                            <option value="opcion1"> Otro</option>
                        </select>
                        <a className='userMiddle_A41' onClick={handleEditClick4}>
                            <img src={Edit2} alt="Edit2" />
                        </a>
                        <h2>Fecha de nacimiento: </h2>
                        <input type="date" id='userInput4'/>
